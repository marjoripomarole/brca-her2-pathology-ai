...
1. External / single-scanner validation in BCNB: replicate the H-Optimus-0 hash-capped patch pilot with Virchow2, then decide whether full WSIs are worth downloading for slide/tissue-area controls. See `external_validation_candidates.md`, `bcnb_exploration.md`, `bcnb_paper_patches_audit.md`, and `bcnb_patch_embedding_control_hoptimus0_hash_capped10_low_zero.md`.
