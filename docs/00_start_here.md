...
1. External / single-scanner validation in BCNB: run patch-sampling/PCA sensitivity or full WSI processing only if the paper needs stronger slide/tissue-area controls. See `external_validation_candidates.md`, `bcnb_exploration.md`, `bcnb_paper_patches_audit.md`, `bcnb_patch_embedding_control_hoptimus0_hash_capped10_low_zero.md`, and `bcnb_patch_embedding_control_virchow2_hash_capped10_low_zero.md`.
