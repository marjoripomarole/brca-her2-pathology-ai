...
### 11. Ran the Available Selected-Slide Clinical HER2 GigaTIME Pilot
...
- CK and Ki67 currently have their highest mean virtual activation in HER2-positive slides and lowest mean activation in HER2-low slides, but this must be rerun after the missing slides are downloaded.
